...
type SubscribeRequest struct {
	...
	ReadFromFollower bool          `protobuf:"varint,6,opt,name=ReadFromFollower,json=readFromFollower,proto3" json:"ReadFromFollower,omitempty"`
}
...
func (m *SubscribeRequest) GetReadFromFollower() bool {
	if m != nil {
		return m.ReadFromFollower
	}
	return false
}
...
type ActivityStreamEvent struct {
	...
	DeleteStreamOp    *DeleteStreamOp    `protobuf:"bytes,3,opt,name=deleteStreamOp" json:"deleteStreamOp,omitempty"`
}
...
func (*ActivityStreamEvent) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{18} }
...
func (m *ActivityStreamEvent) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CreatePartitionOp != nil {
		...
		n5, err := m.CreatePartitionOp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
	...
	if m.DeleteStreamOp != nil {
		...
		n6, err := m.DeleteStreamOp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *SubscribeRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReadFromFollower", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorApi = []byte{
	...
	,
}
