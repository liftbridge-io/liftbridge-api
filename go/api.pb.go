...
type CreateStreamRequest struct {
	...
	RetentionMaxAge      float64 `protobuf:"fixed64,8,opt,name=RetentionMaxAge,proto3" json:"RetentionMaxAge,omitempty"`
	CleanerInterval      float64 `protobuf:"fixed64,9,opt,name=CleanerInterval,proto3" json:"CleanerInterval,omitempty"`
	SegmentMaxBytes      int64   `protobuf:"varint,10,opt,name=SegmentMaxBytes,proto3" json:"SegmentMaxBytes,omitempty"`
	SegmentMaxAge        float64 `protobuf:"fixed64,11,opt,name=SegmentMaxAge,proto3" json:"SegmentMaxAge,omitempty"`
...
func (m *CreateStreamRequest) GetRetentionMaxAge() float64 {
	if m != nil {
...
func (m *CreateStreamRequest) GetCleanerInterval() float64 {
	if m != nil {
...
func (m *CreateStreamRequest) GetSegmentMaxAge() float64 {
	if m != nil {
...
func (m *CreateStreamRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RetentionMaxAge != 0 {
		dAtA[i] = 0x41
		i++
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.RetentionMaxAge))))
		i += 8
	}
	if m.CleanerInterval != 0 {
		dAtA[i] = 0x49
		i++
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.CleanerInterval))))
		i += 8
	}
	...
	if m.SegmentMaxAge != 0 {
		dAtA[i] = 0x59
		i++
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.SegmentMaxAge))))
		i += 8
	}
...
func (m *CreateStreamRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			...
			iNdEx += 8
			m.RetentionMaxAge = float64(math.Float64frombits(v))
		case 9:
			if wireType != 1 {
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.CleanerInterval = float64(math.Float64frombits(v))
		case 10:
			if wireType != 0 {
		...
		case 11:
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.SegmentMaxAge = float64(math.Float64frombits(v))
		case 12:
			if wireType != 0 {
...
var fileDescriptorApi = []byte{
	...
	,
}
