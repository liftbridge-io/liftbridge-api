...
const (
	CompactEnabled_UNKNOWN  CompactEnabled = 0
	CompactEnabled_ENABLED  CompactEnabled = 1
	CompactEnabled_DISABLED CompactEnabled = 2
)

var CompactEnabled_name = map[int32]string{
	0: "UNKNOWN",
	1: "ENABLED",
	2: "DISABLED",
}
var CompactEnabled_value = map[string]int32{
	"UNKNOWN":  0,
	"ENABLED":  1,
	"DISABLED": 2,
}

func (x CompactEnabled) String() string {
	return proto1.EnumName(CompactEnabled_name, int32(x))
}
func (CompactEnabled) EnumDescriptor() ([]byte, []int) { return fileDescriptorApi, []int{0} }
...
func (StartPosition) EnumDescriptor() ([]byte, []int) { return fileDescriptorApi, []int{1} }
...
func (AckPolicy) EnumDescriptor() ([]byte, []int) { return fileDescriptorApi, []int{2} }
...
func (ActivityStreamOp) EnumDescriptor() ([]byte, []int) { return fileDescriptorApi, []int{3} }
...
type CreateStreamRequest struct {
	...
	CompactEnabled       CompactEnabled `protobuf:"varint,13,opt,name=CompactEnabled,proto3,enum=proto.CompactEnabled" json:"CompactEnabled,omitempty"`
}
...
func init() {
	...
	proto1.RegisterEnum("proto.CompactEnabled", CompactEnabled_name, CompactEnabled_value)
...
func (m *CreateStreamRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CompactEnabled != 0 {
		dAtA[i] = 0x68
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.CompactEnabled))
	}
	return i, nil
}
...
func (m *CreateStreamRequest) Size() (n int) {
	...
	if m.CompactEnabled != 0 {
		n += 1 + sovApi(uint64(m.CompactEnabled))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 13:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CompactEnabled |= (CompactEnabled(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorApi = []byte{
	...
	,
}
