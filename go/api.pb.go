...
const (
	...
	ActivityStreamOp_RESUME_PARTITION ActivityStreamOp = 3
)
...
func (*CreatePartitionOp) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{16} }
...
// ResumePartitionOp represents a partition resume operation.
...
func (m *ResumePartitionOp) String() string            { return proto1.CompactTextString(m) }
func (*ResumePartitionOp) ProtoMessage()               {}
func (*ResumePartitionOp) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{19} }
...
type ActivityStreamEvent struct {
	...
	CreatePartitionOp *CreatePartitionOp `protobuf:"bytes,3,opt,name=createPartitionOp" json:"createPartitionOp,omitempty"`
	...
	ResumePartitionOp *ResumePartitionOp `protobuf:"bytes,6,opt,name=resumePartitionOp" json:"resumePartitionOp,omitempty"`
}
...
func (m *ActivityStreamEvent) GetResumePartitionOp() *ResumePartitionOp {
	if m != nil {
...
func init() {
	...
	proto1.RegisterType((*ResumePartitionOp)(nil), "proto.ResumePartitionOp")
...
func (m *ActivityStreamEvent) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CreatePartitionOp != nil {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.CreatePartitionOp.Size()))
	...
	if m.DeleteStreamOp != nil {
		...
		n8, err := m.DeleteStreamOp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
	...
	if m.PauseStreamOp != nil {
		...
		n9, err := m.PauseStreamOp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
	...
	if m.ResumePartitionOp != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.ResumePartitionOp.Size()))
		n10, err := m.ResumePartitionOp.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
var fileDescriptorApi = []byte{
	...
	,
}
