...
// ActivityOp represents an activity stream operation.
type ActivityOp int32

const (
	ActivityOp_CREATE_PARTITION ActivityOp = 0
	ActivityOp_DELETE_STREAM    ActivityOp = 1
)

var ActivityOp_name = map[int32]string{
	0: "CREATE_PARTITION",
	1: "DELETE_STREAM",
}

var ActivityOp_value = map[string]int32{
	"CREATE_PARTITION": 0,
	"DELETE_STREAM":    1,
}

func (x ActivityOp) String() string {
	return proto.EnumName(ActivityOp_name, int32(x))
}

func (ActivityOp) EnumDescriptor() ([]byte, []int) {
...
type ActivityStreamEvent struct {
	Op                   ActivityOp `protobuf:"varint,1,opt,name=op,proto3,enum=proto.ActivityOp" json:"op,omitempty"`
...
func (m *ActivityStreamEvent) GetOp() ActivityOp {
	if m != nil {
		return m.Op
	}
	return ActivityOp_CREATE_PARTITION
}

func (m *ActivityStreamEvent) GetStream() string {
	if m != nil {
		return m.Stream
	}
	return ""
...
func (m *ActivityStreamEvent) GetPartition() int32 {
	if m != nil {
		return m.Partition
	}
	return 0
...
func init() {
	...
	proto.RegisterEnum("proto.ActivityOp", ActivityOp_name, ActivityOp_value)
...
var fileDescriptor_00212fb1f9d3bf1c = []byte{
	...
	,
}
