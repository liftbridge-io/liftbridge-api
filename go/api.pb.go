...
type SubscribeRequest struct {
	...
	ReadReplica    bool          `protobuf:"varint,6,opt,name=readReplica,proto3" json:"readReplica,omitempty"`
}
...
func (m *SubscribeRequest) GetReadReplica() bool {
	if m != nil {
		return m.ReadReplica
	}
	return false
}
...
func (m *SubscribeRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReadReplica", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorApi = []byte{
	...
	,
}
