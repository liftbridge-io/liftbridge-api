...
class APIStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SetStreamConfig = channel.unary_unary(
                '/proto.API/SetStreamConfig',
                request_serializer=api__pb2.SetStreamConfigRequest.SerializeToString,
                response_deserializer=api__pb2.SetStreamConfigResponse.FromString,
                )
...
class APIServicer(object):
    ...
    def SetStreamConfig(self, request, context):
...
def add_APIServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SetStreamConfig': grpc.unary_unary_rpc_method_handler(
                    servicer.SetStreamConfig,
                    request_deserializer=api__pb2.SetStreamConfigRequest.FromString,
                    response_serializer=api__pb2.SetStreamConfigResponse.SerializeToString,
            ),
    }
...
class API(object):
    ...
    def SetStreamConfig(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/proto.API/SetStreamConfig',
            api__pb2.SetStreamConfigRequest.SerializeToString,
            api__pb2.SetStreamConfigResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
